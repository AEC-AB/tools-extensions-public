...
Run `20260925-214417` is a first-pass full sweep of `tools-extensions-public`, covering the StreamBIM credential storage area and the Dalux API key handling area. Headline: one High, one Low, two findings filed, sweep twelve percent complete.
...
- Git history check (`git log -p -S`) confirmed no Dalux or StreamBIM secrets have been committed.
